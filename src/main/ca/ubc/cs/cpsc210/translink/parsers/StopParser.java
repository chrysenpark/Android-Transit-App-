...
public class StopParser {
    ...
    private void parseOneStop(JSONObject jsonObject) throws JSONException {
        ...
        List<String> routesList = new ArrayList<String>(Arrays.asList((Routes.split(","))));

        LatLon latlong = new LatLon(Latitude, Longitude);

        Stop newStop = StopManager.getInstance().getStopWithNumber(StopNo, Name, latlong);

        for (String r : routesList) {
            Route route = RouteManager.getInstance().getRouteWithNumber(r);
